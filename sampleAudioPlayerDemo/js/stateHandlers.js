...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            console.log("START_MODE_LAUNCH: " + JSON.stringify(this.attributes));
            ...
            console.log("START_MODE_LAUNCH_AFTER: " + JSON.stringify(this.attributes));
...
var controller = function () {
    return {
        play: function () {
            ...
            console.log("play_token: " + token);
            var playBehavior = 'REPLACE_ALL';
            var podcast = audioData[this.attributes['playOrder'][this.attributes['index']]];
            console.log("play podcast" + JSON.stringify(podcast));
            var offsetInMilliseconds = this.attributes['offsetInMilliseconds'];
            // Since play behavior is REPLACE_ALL, enqueuedToken attribute need to be set to null.
            this.attributes['enqueuedToken'] = null;

            console.log("play_attribute" + JSON.stringify(this.attributes));
